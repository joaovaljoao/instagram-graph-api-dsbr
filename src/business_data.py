...
endpoint = os.getenv('GRAPH_DOMAIN') + os.getenv('VERSION') + "/" + os.getenv('FACEBOOK_ID')

def get_business_data(username: str, fields: str) -> dict:
    '''
    Faz um request ao Graph API para obter os dados de um usuário do Instagram em formato de dicionário.
